...
-- write a query that returns all the info of the invoices in 2019-05-23. 

select * from invoices where invoice_date = 2019-05-23;
...
/* The Chinook team decided to run a marketing campaign in 
Brazil, Canada, india, and Sweden. They will start with 
the country that has the least customers. Using the customer table,
 write a query that returns the first name, last name, and state
